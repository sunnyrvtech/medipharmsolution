...
module.exports = {
    ...
    userEnrolledNotification: function(data) {
       ...
       html+='<p>We have added this <b>'+data.course_name+'</b> in your account setting.Please login your account and check all course modules in your my account setting.For any issue,please contact us at admin@medipharmsolutions.com</p>';
       return {
          html: html
      }
    }
